...
<footer>
    <div id="bottomMenu">
        ...
        <div id="sns">
            <ul>
                <li><a href="#"><img src="http://localhost/KBO/img/sns-1.png"></a></li>
                <li><a href="#"><img src="http://localhost/KBO/img/sns-2.png"></a></li>
                <li><a href="#"><img src="http://localhost/KBO/img/sns-3.png"></a></li>
            </ul>
        </div>
    </div>
    <div id="company">
